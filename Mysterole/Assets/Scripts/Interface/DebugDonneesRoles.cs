// Programme : Menu de débogage : Données des Roles
// Auteur : Jean-Michel Beauvais
// Gère l'affichage et l'actualisation des données sur les roles de joueurs ou de monstres existants dans le système.
